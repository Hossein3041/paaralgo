...
Die Visualisierung wird erstellt durch analyse_plots.py - ausgeführt wiefolgt:
analyse_plots.py laufzeit.tsv laufzeit
analyse_plots.py laufzeit.tsv beschleunigung
analyse_plots.py laufzeit.tsv effizienz
